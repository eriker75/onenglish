...
export default function TellMeAboutItWrapper({ onCancel, onSuccess }: TellMeAboutItWrapperProps) {
  ...
  return (
    <div className="space-y-6 p-4">
      <div className="flex justify-between items-center border-b pb-4">
        <h2 className="text-xl font-bold text-gray-800">Create Tell Me About It Question</h2>
