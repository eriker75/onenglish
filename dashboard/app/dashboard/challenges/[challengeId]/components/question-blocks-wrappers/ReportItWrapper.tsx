...
export default function ReportItWrapper({
  ...
  const reportItQuestion = existingQuestion as ReportItQuestion | undefined;
  ...
  const createQuestionMutation = useMutation({
    mutationFn: async (formData: FormData) => {
      const response = await api.post("/questions/create/report_it", formData, {
        headers: {
    ...
    onSuccess: () => {
      toast({
        title: "Success",
        description: "Reported speech question created successfully",
        variant: "default",
      });
