...
const AddSchoolModal: React.FC = () => {
  ...
  const handleCreate = async (e: React.FormEvent) => {
    ...
    console.log("School created (demo):", formData);
    setIsLoading(false);
    closeModal();
  };
      ...
      <form onSubmit={handleCreate} className="space-y-4">
        ...
        <div className="flex gap-3 pt-4">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="flex-1 bg-[#33CC00] hover:bg-[#33CC00]/90 text-white py-3 rounded-lg font-semibold flex items-center justify-center gap-2 transition-all disabled:opacity-50"
          >
            {isLoading ? "Creando..." : "Create School"}
          </button>
        </div>
      </form>
    </div>
