...
/**
 * Phases are groupings within stages for organizing questions.
 * Format: "phase_1", "phase_2", "phase_3", etc.
 *
 * Phases are dynamic labels used for:
 * - Filtering questions in queries
 * - Grouping similar difficulty levels
 * - Progressive learning paths
 *
 * Example usage:
 * - phase_1: Basic level questions
 * - phase_2: Intermediate level questions
 * - phase_3: Advanced level questions
 */
...
export const FAST_TEST = {
  ...
  example: {
    challengeId: 'uuid-challenge-1',
    stage: 'WRITING',
    phase: 'phase_1', // Group ~20 similar questions in same phase
    position: 1,
    type: 'fast_test',
    points: 5,
    timeLimit: 30,
...
export interface QuestionTemplate {
  ...
  challengeId: string;
  stage: QuestionStage;
  phase: string; // Format: "phase_1", "phase_2", etc.
  position: number; // Order within phase
 ...
 *    - GET /questions (list with filters: challengeId, stage, phase)
 ...
 *    - PATCH /questions/:id/phase (update phase)
 ...
 *
 * Question (core table)
 * - id, challengeId, stage, phase, position, type
