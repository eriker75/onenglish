...
// Dynamic import for faker (ESM module)
...
async function seedPostgreSQL() {
  ...
  await Promise.all([
    ...
    // Coordinator can manage challenges and read users
    prisma.rolePermission.create({
      data: {
  ...
  const schoolLincoln = await prisma.school.create({
    data: {
      ...
      email: faker.internet.email({ provider: 'lincolnhs.edu' }).toLowerCase(),
      website: 'https://www.lincolnhs.edu',
      description:
        faker.company.catchPhrase() + ' - Premier English learning institution',
      isActive: true,
    },
  });
  ...
  const schoolJefferson = await prisma.school.create({
    data: {
      ...
      description:
        faker.company.catchPhrase() + ' - Excellence in English education',
      isActive: true,
    },
  });
  ...
  // Generate additional random schools (2 more) for more realistic dataset
  ...
  const additionalSchools = await Promise.all([
    prisma.school.create({
      data: {
        ...
        type: faker.helpers.arrayElement(['public', 'private', 'charter']),
        address: faker.location.streetAddress(),
        ...
        postalCode: faker.location.zipCode(),
        phone: faker.phone.number(),
        email: faker.internet.email({ provider: 'academy.edu' }).toLowerCase(),
        website: `https://www.${faker.internet.domainWord()}.edu`,
        description: faker.company.catchPhrase(),
    ...
    prisma.school.create({
      data: {
        name: faker.location.city() + ' English Institute',
        code: faker.string.alphanumeric({ length: 6, casing: 'upper' }),
        type: faker.helpers.arrayElement(['public', 'private', 'charter']),
        address: faker.location.streetAddress(),
        city: faker.location.city(),
        ...
        email: faker.internet
          ...
          .toLowerCase(),
        description:
          faker.company.catchPhrase() + ' - Dedicated to English excellence',
        isActive: true,
      },
    }),
  ]);
  ...
  // Create Admin Profiles with Faker
  ...
  // Create Coordinator Profiles with Faker
  const coordinatorProfile1 = await prisma.coordinator.create({
    data: {
      ...
      phone: faker.phone.number(),
      avatar: faker.image.avatar(),
      bio: `Academic coordinator with ${faker.number.int({ min: 5, max: 20 })} years of experience in educational leadership and English language programs`,
  ...
  const coordinatorProfile2 = await prisma.coordinator.create({
    data: {
      ...
      phone: faker.phone.number(),
      avatar: faker.image.avatar(),
      bio: `${faker.person.jobTitle()} at Jefferson Academy with expertise in curriculum development`,
  ...
  const coordinatorProfile3 = await prisma.coordinator.create({
    data: {
      ...
      phone: faker.phone.number(),
      avatar: faker.image.avatar(),
      bio: `${faker.person.jobTitle()} specializing in English language education and student development`,
  ...
  // Create Teacher Profiles with Faker
  ...
  const teacherProfile1 = await prisma.teacher.create({
    data: {
      ...
      phone: faker.phone.number(),
      avatar: faker.image.avatar(),
      bio: `${faker.person.jobTitle()} with ${faker.number.int({ min: 3, max: 15 })} years of experience. Specialized in ${faker.helpers.arrayElement(teacherSpecializations)}`,
      schoolId: schoolLincoln.id,
      isActive: true,
    },
  });
  ...
  const teacherProfile2 = await prisma.teacher.create({
    data: {
      ...
      phone: faker.phone.number(),
      avatar: faker.image.avatar(),
      bio: `ESL instructor certified in ${faker.helpers.arrayElement(teacherSpecializations)}. ${faker.lorem.sentence()}`,
      schoolId: schoolLincoln.id,
      isActive: true,
    },
  });
  ...
  const teacherProfile3 = await prisma.teacher.create({
    data: {
      ...
      phone: faker.phone.number(),
      avatar: faker.image.avatar(),
      bio: `Expert in ${faker.helpers.arrayElement(teacherSpecializations)} with international teaching experience`,
      schoolId: schoolJefferson.id,
      isActive: true,
    },
  });
  ...
  // Create Student Profiles with Faker
  ...
  const studentProfile1 = await prisma.student.create({
    data: {
      ...
      phone: faker.phone.number(),
      avatar: faker.image.avatar(),
      bio: `English learner at ${faker.helpers.arrayElement(englishLevels)} level. Goal: ${faker.helpers.arrayElement(learningGoals)}. ${faker.lorem.sentence()}`,
      schoolId: schoolLincoln.id,
      isActive: true,
    },
  });
  ...
  const studentProfile2 = await prisma.student.create({
    data: {
      ...
      phone: faker.phone.number(),
      avatar: faker.image.avatar(),
      bio: `Currently at ${faker.helpers.arrayElement(englishLevels)} level, focusing on ${faker.helpers.arrayElement(['grammar', 'vocabulary', 'pronunciation', 'writing', 'listening'])} improvement`,
      schoolId: schoolLincoln.id,
      isActive: true,
    },
  });
  ...
  const studentProfile3 = await prisma.student.create({
    data: {
      ...
      phone: faker.phone.number(),
      avatar: faker.image.avatar(),
      bio: `Advanced learner preparing for ${faker.helpers.arrayElement(['TOEFL', 'IELTS', 'Cambridge FCE', 'TOEIC'])}. Current level: ${faker.helpers.arrayElement(['B1+', 'C1'])}`,
      schoolId: schoolJefferson.id,
      isActive: true,
    },
  });
  ...
  const studentProfile4 = await prisma.student.create({
    data: {
      ...
      phone: faker.phone.number(),
      avatar: faker.image.avatar(),
      bio: `Beginner student starting from ${faker.helpers.arrayElement(['-A1', 'A1', 'A1+'])} level. Interested in ${faker.helpers.arrayElement(learningGoals)}`,
      schoolId: schoolWashington.id,
      isActive: true,
    },
  });
  ...
  // Create Challenges with Faker
  // Available levels in the system: -A1, A1, A1+, A2, A2+, B1, B1+, C1
  ...
  const beginnerChallenge = await prisma.challenge.create({
    data: {
      ...
      description: `${faker.lorem.sentence()} Complete 5 Olympic phases to master basic English skills including listening, speaking, reading, and writing.`,
      category: faker.helpers.arrayElement(challengeCategories),
      level: 'A1',
      difficulty: 'easy',
  ...
  const intermediateChallenge = await prisma.challenge.create({
    data: {
      ...
      description: `${faker.lorem.sentence()} Advanced Olympic challenge for intermediate learners focusing on practical communication and comprehension.`,
      category: faker.helpers.arrayElement(challengeCategories),
      level: 'A2+',
      difficulty: 'medium',
      totalPoints: faker.number.int({ min: 900, max: 1100 }),
      isPublished: true,
      isActive: true,
    },
  });
  ...
  const advancedChallenge = await prisma.challenge.create({
    data: {
      ...
      description: `${faker.lorem.sentence()} Expert level Olympic challenge designed for advanced learners preparing for professional or academic excellence.`,
      category: faker.helpers.arrayElement(challengeCategories),
      level: 'B1+',
      difficulty: 'hard',
      totalPoints: faker.number.int({ min: 1400, max: 1600 }),
      isPublished: true,
      isActive: true,
    },
  });
  ...
  // Create School Challenges (assign challenges to schools)
  await Promise.all([
  ...
  // Create Student Challenges with realistic progress using Faker
  await Promise.all([
    ...
    prisma.studentChallenge.create({
      data: {
        ...
        challengeId: intermediateChallenge.id,
        currentPhase: faker.number.int({ min: 2, max: 4 }),
        totalScore: faker.number.int({ min: 300, max: 700 }),
        totalTimeSpent: faker.number.int({ min: 5400, max: 14400 }), // 1.5h - 4h
        isCompleted: false,
        assignedAt: faker.date.past({ years: 0.3 }),
        dueDate: faker.date.future({ years: 0.1 }),
        startedAt: faker.date.recent({ days: 60 }),
        lastActivityAt: faker.date.recent({ days: 1 }),
        notes: 'Making good progress. ' + faker.lorem.sentence(),
      },
    }),
    prisma.studentChallenge.create({
      data: {
        ...
        challengeId: advancedChallenge.id,
        currentPhase: faker.number.int({ min: 1, max: 2 }),
        totalScore: faker.number.int({ min: 100, max: 400 }),
        totalTimeSpent: faker.number.int({ min: 3600, max: 10800 }), // 1h - 3h
        isCompleted: false,
    ...
    prisma.studentChallenge.create({
      data: {
        ...
        challengeId: beginnerChallenge.id,
        currentPhase: 1,
        totalScore: faker.number.int({ min: 0, max: 50 }),
        totalTimeSpent: faker.number.int({ min: 0, max: 1800 }), // 0 - 30min
        isCompleted: false,
        assignedAt: faker.date.recent({ days: 7 }),
        dueDate: faker.date.future({ years: 0.5 }),
        startedAt: faker.date.recent({ days: 5 }),
        lastActivityAt: faker.date.recent({ days: 1 }),
        notes: 'Just started. ' + faker.lorem.sentence(),
      },
    }),
  ]);
  ...
  // Create User Activities with Faker
  ...
  // Generate 2-5 activities per user
    ...
    for (let i = 0; i < numActivities; i++) {
      userActivities.push(
        prisma.userActivity.create({
          data: {
            userId: user.id,
            action: faker.helpers.arrayElement(activityActions),
            ...
            resourceId: faker.helpers.maybe(() => faker.string.uuid(), {
              probability: 0.5,
            }),
  ...
  console.log(
    `✅ Created ${userActivities.length} user activities with realistic data`,
  );

  // Create Questions (100+ questions)
  ...
  // Create 30 VOCABULARY questions
  for (let i = 0; i < 30; i++) {
    const stage = 'VOCABULARY';
    const type = faker.helpers.arrayElement(questionTypes.VOCABULARY);
    const challengeId = faker.helpers.arrayElement([
    ...
    if (type === 'image_to_multiple_choices') {
      content = { type: 'image', id: faker.string.uuid() };
      options = [faker.lorem.word(), faker.lorem.word(), faker.lorem.word(), faker.lorem.word()];
      answer = options[0];
    } else if (type === 'wordbox') {
      content = [
        [faker.string.alpha({ length: 1, casing: 'upper' }), faker.string.alpha({ length: 1, casing: 'upper' }), faker.string.alpha({ length: 1, casing: 'upper' })],
        [faker.string.alpha({ length: 1, casing: 'upper' }), faker.string.alpha({ length: 1, casing: 'upper' }), faker.string.alpha({ length: 1, casing: 'upper' })],
        [faker.string.alpha({ length: 1, casing: 'upper' }), faker.string.alpha({ length: 1, casing: 'upper' }), faker.string.alpha({ length: 1, casing: 'upper' })],
      ];
      ...
      configuration = { totalAssociations: faker.number.int({ min: 15, max: 25 }) };
    }
    ...
    allQuestions.push(
      prisma.question.create({
        data: {
          ...
          maxAttempts: faker.number.int({ min: 2, max: 4 }),
          text: faker.lorem.sentence(),
          instructions: faker.lorem.sentence(),
          validationMethod: faker.helpers.arrayElement(['AUTO', 'IA']),
          content,
          options,
          answer,
  ...
  // Create 25 GRAMMAR questions
  for (let i = 0; i < 25; i++) {
    const stage = 'GRAMMAR';
    const type = faker.helpers.arrayElement(questionTypes.GRAMMAR);
    const challengeId = faker.helpers.arrayElement([
      beginnerChallenge.id,
      intermediateChallenge.id,
      advancedChallenge.id,
    ...
    if (type === 'unscramble') {
      const words = [faker.lorem.word(), faker.lorem.word(), faker.lorem.word(), faker.lorem.word()];
      content = faker.helpers.shuffle(words);
      answer = words;
    } else if (type === 'tenses') {
      ...
      content = `"${faker.lorem.sentence()}" ${faker.person.firstName()} said.`;
    ...
    allQuestions.push(
      prisma.question.create({
        data: {
          ...
          timeLimit: faker.number.int({ min: 45, max: 150 }),
          maxAttempts: faker.number.int({ min: 2, max: 3 }),
          text: faker.lorem.sentence(),
          instructions: faker.lorem.sentence(),
          validationMethod: faker.helpers.arrayElement(['AUTO', 'IA']),
          content,
  ...
  // Create 20 LISTENING questions
  for (let i = 0; i < 20; i++) {
    const stage = 'LISTENING';
    const type = faker.helpers.arrayElement(questionTypes.LISTENING);
    const challengeId = faker.helpers.arrayElement([
      beginnerChallenge.id,
      intermediateChallenge.id,
      advancedChallenge.id,
    ...
    if (type === 'word_match') {
      content = [{ type: 'audio', id: faker.string.uuid() }];
      options = [faker.lorem.word(), faker.lorem.word(), faker.lorem.word(), faker.lorem.word()];
      answer = options[0];
    } else if (type === 'gossip') {
      content = { type: 'audio', id: faker.string.uuid() };
      ...
      content = { type: 'video', id: faker.string.uuid() };
      options = [faker.lorem.word(), faker.lorem.word(), faker.lorem.word(), faker.lorem.word()];
      answer = options[0];
    }
    ...
    allQuestions.push(
      prisma.question.create({
        data: {
          ...
          timeLimit: faker.number.int({ min: 60, max: 180 }),
          maxAttempts: faker.number.int({ min: 2, max: 3 }),
          text: faker.lorem.sentence(),
          instructions: faker.lorem.sentence(),
          validationMethod: faker.helpers.arrayElement(['AUTO', 'IA']),
  ...
  // Create 15 WRITING questions
  for (let i = 0; i < 15; i++) {
    const stage = 'WRITING';
    const type = faker.helpers.arrayElement(questionTypes.WRITING);
    const challengeId = faker.helpers.arrayElement([
      beginnerChallenge.id,
      intermediateChallenge.id,
      advancedChallenge.id,
    ...
    if (type === 'sentence_maker') {
      content = [
        { type: 'image', id: faker.string.uuid() },
        { type: 'image', id: faker.string.uuid() },
      ];
    } else if (type === 'fast_test') {
      content = [faker.lorem.word(), faker.lorem.word()];
      options = [faker.lorem.word(), faker.lorem.word(), faker.lorem.word(), faker.lorem.word()];
      answer = options[0];
    } else if (type === 'tales') {
      content = [{ type: 'image', id: faker.string.uuid() }];
    ...
    allQuestions.push(
      prisma.question.create({
        data: {
          ...
          timeLimit: faker.number.int({ min: 120, max: 300 }),
          maxAttempts: faker.number.int({ min: 1, max: 2 }),
          text: faker.lorem.sentence(),
          instructions: faker.lorem.sentence(),
          validationMethod: 'IA',
          content,
  ...
  // Create 15 SPEAKING questions
  for (let i = 0; i < 15; i++) {
    const stage = 'SPEAKING';
    const type = faker.helpers.arrayElement(questionTypes.SPEAKING);
    const challengeId = faker.helpers.arrayElement([
      beginnerChallenge.id,
      intermediateChallenge.id,
      advancedChallenge.id,
    ...
    allQuestions.push(
      prisma.question.create({
        data: {
          ...
          timeLimit: faker.number.int({ min: 180, max: 360 }),
          maxAttempts: faker.number.int({ min: 1, max: 2 }),
          text: faker.lorem.sentence(),
          instructions: faker.lorem.sentence(),
          validationMethod: 'IA',
  ...
  // Each student answers a random subset of questions (100-150 answers per student)
  for (const student of allStudents) {
    ...
    for (const question of questionsToAnswer) {
      ...
      for (let attempt = 1; attempt <= attemptCount; attempt++) {
        const isCorrect = faker.datatype.boolean({ probability: attempt === attemptCount ? 0.65 : 0.35 });
        const timeSpent = faker.number.int({ min: 15, max: question.timeLimit || 120 });
        const pointsEarned = isCorrect ? question.points : 0;
        
        let userAnswer: any;
        if (question.options) {
          userAnswer = faker.helpers.arrayElement(question.options);
        } else {
          userAnswer = faker.lorem.sentence();
        }
  ...
  // Create QuestionSchoolStats entries
  console.log('\n📈 Creating question-school stats entries...');

  const questionSchoolStatsSet = new Set<string>();
  const questionSchoolStats: any[] = [];
  ...
  console.log(
    `📱 ACTIVITIES:       ${userActivities.length} user activities generated`,
  );
  console.log('');
  console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  ...
  console.log('');
  console.log(
    '💡 TIP: Use these credentials to test different permission levels',
  );
